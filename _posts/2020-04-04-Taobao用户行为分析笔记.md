---
layout:     post
title:      Taobao用户行为分析及用户价值分析笔记
subtitle:   2020.4.4向新冠肺炎疫情牺牲烈士和逝世同胞默哀，愿逝者安息，愿生者奋发，愿祖国昌盛
date:       2020-04-04
author:     terese
...
终于完成了这个分析项目了 ![[嘻嘻]](https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/33/2018new_xixi_org.png)![[嘻嘻]](https://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/33/2018new_xixi_org.png)，实践太重要了，在实践中攻克一个个困难，最后完成整个项目的分析，能够找到兴趣所在，这是我最大的收获了吧。 以下是我记录实践中遇到的问题、解决方法以及笔记：
